...
export declare class CalendarViewBase extends BaseComponent<ICalendarViewProps, ICalendarViewState> {
    ...
    _onDayHoverIn: (ev: ICellHoverEvent) => void;
    _onDayHoverOut: (ev: ICellHoverEvent) => void;
    _onLabelClick: (args: ILabelClickEvent) => void;
    _onDayClick: (args: ICellClickEvent) => void;
